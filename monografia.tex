...
\begin{figure}[H]
    \label{fig:rcpstructure}
    \centering
       \includegraphics[scale=.65]{figures/f03-02}
    \caption{Um diagrama com os principais componentes do 
        RCP}
...
O RSP ( \textit{Reality Signal Processor} ) é um processador que se especializa na execução das transformações
